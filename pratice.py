...
# new project 
# 7️⃣ Library Management System (Basic)
...
# dic={}
# def add_books():
#        name=str(input("Enter your name for book record:   "))
#        books=str(input("Enter your book name  which you want to add:   "))
#        dic[name]=books
#        print("your book successfully added ")
# def display_books():
#        if not dic:
#               print("your have not book this time ")
#        else:
#               print("------your all books-----")
#               for key,value in dic.items():
#                     print(key,":",value)
# def issue_books():
#       name2=str(input("Enter your book which have issue:   "))

# while True:
#        print("----Library Management System----")
#        print("1. add_books")
#        print("2. display_books")
#        print("3. Issue_books")
